...
namespace Api.Controllers
{
    ...
    [Authorize]
    public class RegexAnalyzersController : Controller
    {
        private readonly ILogger<RegexAnalyzersController> _logger;
        private readonly IMapper _mapper;
        private readonly ISender _mediator;

        public RegexAnalyzersController(
            ILogger<RegexAnalyzersController> logger,
            IMapper mapper,
            ISender mediator)
        {
            _logger = logger;
